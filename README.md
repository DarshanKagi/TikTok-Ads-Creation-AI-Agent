...
-   `src/`: Modular source code directory.
    ...
    -   `api_interface.py`: TikTokAPI abstract base class.
    -   `api_real.py`: Real TikTok API implementation.
    -   `api_mock.py`: Mock TikTok API for testing/demo.
    -   `agent.py`: Core AdAgent logic and LLM interaction.
    -   `server.py`: FastAPI callback server for OAuth.
    -   `ui.py`: Gradio user interface.
    -   `instances.py`: Dependency injection/shared instances.
